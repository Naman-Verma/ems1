...
public class AttendanceReport extends javax.swing.JFrame {
     ...
     */
    QueryExecution attendQuery;
    
    public AttendanceReport() {
        initComponents();
        setExtendedState(MAXIMIZED_BOTH);
        attendQuery = new QueryExecution();
    ...
    private void initComponents() {
        ...
        reportGroup1 = new javax.swing.ButtonGroup();
        reportGroup2 = new javax.swing.ButtonGroup();
        ...
        reportGroup2.add(selectDepartment);
    ...
    private void showActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showActionPerformed
        ...
        if(thisMonth.isSelected() && allDepartments.isSelected()) {
            attendQuery.setParameters("ReportAttendanceThisMonth", null);
            attendQuery.getReport(ReportBase.model);
            ...
            if( fromDate.getDate() == null){
                ...
                attendQuery.setParameters("ReportAttendanceFromTo", fromDate,toDate);
                attendQuery.getReport(ReportBase.model);
            } else {
                JOptionPane.showMessageDialog(this, "Check From And To Dates");
            }
        } else if(thisMonth.isSelected() && selectDepartment.isSelected()) {
            attendQuery.setParameters("ReportAttendanceThisMonthThisDepartment", deptCombo);
            attendQuery.getReport(ReportBase.model);
            ...
            if( fromDate.getDate() == null){
                ...
                attendQuery.setParameters("ReportAttendanceFromToThisDepartment", fromDate,toDate,deptCombo);
                attendQuery.getReport(ReportBase.model);
            } else {
                JOptionPane.showMessageDialog(this, "Check From And To Dates");
            }
        } else if(thisMonth.isSelected() && employee.isSelected()) {
            attendQuery.setParameters("ReportAttendanceThisMonthThisEmployee", employeeID);
            attendQuery.getReport(ReportBase.model);
            int returnedValue = attendQuery.getReturnedValue();
            if(returnedValue == 0){
            ...
            if( fromDate.getDate() == null){
                ...
                attendQuery.setParameters("ReportAttendanceFromToThisEmployee", fromDate,toDate,employeeID);
                attendQuery.getReport(ReportBase.model);
                int returnedValue = attendQuery.getReturnedValue();
                if(returnedValue == 0){
                    JOptionPane.showMessageDialog(this, "Wrong EmployeeID");
    ...
    private javax.swing.ButtonGroup reportGroup1;
    private javax.swing.ButtonGroup reportGroup2;
