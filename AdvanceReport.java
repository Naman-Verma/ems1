 ...
 * @author ask
 */
public class AdvanceReport extends javax.swing.JFrame {

    /**
     * Creates new form AdvanceReport
     */
    ...
    private void initComponents() {
        ...
        setTitle("Advance Payment Report");
    ...
    private void showActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showActionPerformed
        ...
        if(thisMonth.isSelected() && allDepartments.isSelected()) {
            attendQuery.setParameters("ReportAdvanceThisMonth", null);
            ...
            if( fromDate.getDate() == null){
                ...
                attendQuery.setParameters("ReportAdvanceFromTo", fromDate,toDate);
                attendQuery.getReport(ReportBase.model);
            } else {
                JOptionPane.showMessageDialog(this, "Check From And To Dates");
            }
        } else if(thisMonth.isSelected() && selectDepartment.isSelected()) {
            attendQuery.setParameters("ReportAdvanceThisMonthThisDepartment", deptCombo);
            attendQuery.getReport(ReportBase.model);
            ...
            if( fromDate.getDate() == null){
                ...
                attendQuery.setParameters("ReportAdvanceFromToThisDepartment", fromDate,toDate,deptCombo);
                attendQuery.getReport(ReportBase.model);
            } else {
                JOptionPane.showMessageDialog(this, "Check From And To Dates");
            }
        } else if(thisMonth.isSelected() && employee.isSelected()) {
            attendQuery.setParameters("ReportAdvanceThisMonthThisEmployee", employeeID);
            attendQuery.getReport(ReportBase.model);
            ...
            if( fromDate.getDate() == null){
                ...
                attendQuery.setParameters("ReportAdvanceFromToThisEmployee", fromDate,toDate,employeeID);
                attendQuery.getReport(ReportBase.model);
                int returnedValue = attendQuery.getReturnedValue();
                if(returnedValue == 0){
                    JOptionPane.showMessageDialog(this, "Wrong EmployeeID");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdvanceReport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdvanceReport().setVisible(true);
            }
        });
    }
